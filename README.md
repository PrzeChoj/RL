...
python3 ./dqn-atari-master/train.py Skiing ./dqn-atari-master/Skiing_Adam_eden_.pt --replay_memory_size 2000 --replay_start_size 300 --checkpoint --minibatch_size 64
```
